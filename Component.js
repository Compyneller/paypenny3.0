  ...
  return (
    <>
      <div className="calculator-section">
        <h2 className="second-main-header">Invest smarter with Earn Wallet</h2>
        <br />
        ...
        <div className="calculate-section">
          <div className="calculate-part">
            ...
            <div className="calculate-try">
              <span>
                Try it now &nbsp; <img src="media/down-arrow.gif" />
              </span>
            </div>
            <label>Amount : &nbsp; </label>
            <input
            ...
            <select name="duration" id="duration" onChange={SetValue}>
              <option value="10" className="input_time">
                10 days
              </option>
              <option value="15" className="input_time1">
                15 days
              </option>
              <option value="30" className="input_time2">
                30 days
              </option>
              <option value="45" className="input_time3">
                45 days
              </option>
              <option value="60" className="input_time4">
                60 days
              </option>
              <option value="90" className="input_time5">
                90 days
              </option>
              <option value="180" className="input_time6">
                180 days
              </option>
              <option value="365" className="input_time7">
                365 days
              </option>
            </select>
            ...
            />
            <button onClick={Calculator} className="main-output-button">
              Maturity Amount
            </button>{" "}
            <span id="output_1" className="output_part">
              100.27{" "}
            </span>
          </div>
